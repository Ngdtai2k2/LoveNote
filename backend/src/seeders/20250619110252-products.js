    ...
    await queryInterface.bulkInsert('products', [
      {
        ...
        price: 5000,
        discount: 0,
        thumbnail_url: '/assets/images/matrix-love-rain.png',
        demo_video_url: '#',
        rating: 0,
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        price: 30000,
        discount: 0,
        thumbnail_url: '/assets/images/heart-beat-visualizer.png',
        demo_video_url: '#',
        rating: 0,
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        price: 20000,
        discount: 0,
        thumbnail_url: '/assets/images/galaxy-love-letter.png',
        demo_video_url: '#',
        rating: 0,
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        price: 10000,
        discount: 0,
        thumbnail_url: '/assets/images/matrix-rain-text.png',
        demo_video_url: '#',
        rating: 0,
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        price: 5000,
        discount: 0,
        thumbnail_url: '/assets/images/memory-overflow.png',
        demo_video_url: '#',
        rating: 0,
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        price: 35000,
        discount: 0,
        thumbnail_url: '/assets/images/bloom-galaxy.png',
        demo_video_url: '#',
        rating: 0,
        created_at: new Date(),
        updated_at: new Date(),
